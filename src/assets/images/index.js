...
export const UserIcon = require('./icon/userIcon.png');
export const UserIconOrange = require('./icon/emailIconOrange.png');
export const PhonelIcon = require('./icon/phoneIcon.png');
export const BuildinglIcon = require('./icon/buildingIcon.png');
